...
- `app_automation_msdev_cdp_refresh` — refresh work-app snapshots through `ms-dev` Windows Chrome CDP using the PowerShell WSL escape route when local Playwright/Tendril cannot reach Windows browser state.
