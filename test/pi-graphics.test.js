...
test("pi-graphics settings source maps minimal env", async () => {
  ...
  assert.match(source, /Do not fill editable whitespace with placeholder graphics/);
  ...
  assert.match(source, /Expected live cursor: single-cell placeholder art at the text cursor; larger relative glow is preview-only/);
