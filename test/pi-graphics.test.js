...
test("pi-graphics settings source maps minimal env", async () => {
  ...
  assert.match(source, /PI_GRAPHICS_EDITOR_DYNAMIC_IN_TMUX/);
  assert.match(source, /PI_GRAPHICS_EDITOR_DYNAMIC/);
  ...
  assert.match(source, /values: \["off", "on"\]/);
  assert.match(source, /values: \["fill", "topLeft"\]/);
  ...
  assert.match(source, /editor static\|unicode\|relative/);
...
test("pi-graphics extension source is the slim graphics primitive layer", async () => {
  ...
  assert.match(source, /function statusIndicatorsEnabled/);
  assert.match(source, /PI_GRAPHICS_STATUS_INDICATORS/);
  assert.match(source, /function buildStatusIndicatorPrefix/);
  assert.match(source, /!statusIndicatorsEnabled\(\) \|\| !ensureUnicodePlacement\(state\)/);
  assert.match(source, /function decorateStatusValue/);
  assert.match(source, /if \(!statusIndicatorsEnabled\(\)\) return value/);
  ...
  assert.match(source, /!statusIndicatorsEnabled\(\) \|\| !config/);
