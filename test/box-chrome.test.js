...
test("renderBoxStripPng effect variants produce distinct graphics", () => {
  const variants = ["glass", "aurora", "scanline", "circuit", "sparkle", "cloud", "compose", "facet", "prism", "veil", "scrim", "frost", "holo", "lattice", "contour", "folio", "manuscript", "note", "tapestry", "weave", "tag", "badge", "glyph", "sextant", "compass", "terminal", "prompt", "rig", "schematic", "blueprint", "vine", "dendrite", "helix", "braid", "metronome", "shuttle", "hourglass", "signal", "halo", "margin", "caret", "frame", "bevel", "chamfer", "atelier", "constellation", "swatch", "palette", "satellite", "orbit", "emblem", "crest", "sigil", "rune", "workbench", "panel", "fold", "archive", "candle", "lantern", "ballot", "choice", "nebula", "ticker", "waveform", "masthead", "marquee", "ribbon", "logbook", "ledger", "lens", "aperture", "gauge", "dial", "console", "slider", "caliper", "tile", "mosaic", "portal", "keyring", "keystone"];
