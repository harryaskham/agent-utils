...
test("renderBoxStripPng effect variants produce distinct graphics", () => {
  const variants = ["glass", "aurora", "scanline", "circuit", "sparkle", "cloud", "prism", "veil", "holo", "lattice", "contour", "manuscript", "weave", "badge", "glyph", "compass", "prompt", "schematic", "blueprint", "dendrite", "braid", "metronome", "signal", "halo", "caret", "chamfer", "constellation", "orbit", "rune", "fold", "lantern", "nebula", "waveform", "ribbon", "aperture", "dial", "slider", "caliper", "mosaic", "keyring", "keystone"];
