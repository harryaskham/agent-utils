...
test("renderBoxStripPng effect variants produce distinct graphics", () => {
  const variants = ["glass", "aurora", "scanline", "circuit", "sparkle", "cloud", "prism", "veil", "frost", "holo", "lattice", "contour", "manuscript", "weave", "badge", "glyph", "compass", "prompt", "schematic", "blueprint", "dendrite", "braid", "metronome", "signal", "halo", "caret", "chamfer", "constellation", "palette", "orbit", "crest", "rune", "panel", "fold", "lantern", "nebula", "waveform", "marquee", "ribbon", "aperture", "dial", "slider", "caliper", "mosaic", "keyring", "keystone"];
