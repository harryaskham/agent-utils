...
test("renderBoxStripPng effect variants produce distinct graphics", () => {
  const variants = ["glass", "aurora", "scanline", "circuit", "sparkle", "cloud", "facet", "prism", "veil", "scrim", "frost", "holo", "lattice", "contour", "manuscript", "tapestry", "weave", "tag", "badge", "glyph", "sextant", "compass", "prompt", "schematic", "blueprint", "vine", "dendrite", "helix", "braid", "metronome", "shuttle", "hourglass", "signal", "halo", "caret", "bevel", "chamfer", "atelier", "constellation", "swatch", "palette", "satellite", "orbit", "emblem", "crest", "sigil", "rune", "panel", "fold", "archive", "lantern", "choice", "nebula", "ticker", "waveform", "masthead", "marquee", "ribbon", "ledger", "lens", "aperture", "gauge", "dial", "slider", "caliper", "tile", "mosaic", "portal", "keyring", "keystone"];
