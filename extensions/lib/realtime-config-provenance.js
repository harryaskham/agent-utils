...
export const REALTIME_CONFIG_PROVENANCE = [
  ...
  { field: "reasoningEffort", env: ["PI_RT_REASONING_EFFORT"], persisted: null, default: "low", notes: "GPT Realtime 2.x supports reasoning.effort; low keeps latency down while enabling commentary preambles. /rt reasoning=off disables" },
  { field: "sendReasoning", env: ["PI_RT_SEND_REASONING"], persisted: null, default: true, notes: "send response.reasoning on the proxy path too; auto-falls back once if the endpoint rejects it" },
  { field: "commentaryMode", env: ["PI_RT_COMMENTARY"], persisted: null, default: "thinking", notes: "phase rendering for 2.x commentary preambles: thinking|text|hidden (lib/realtime-phases.js)" },
