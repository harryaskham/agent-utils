...
export function describeParameterSchema() {
  return {
    ...
    describeModel: Type.Optional(Type.String({ description: `Vision model as provider/model. Resolved in order: this param, KITTY_IMAGE_PREVIEW_DESCRIBE_MODEL, settings.json kittyImagePreview.describeModel, then ${DEFAULT_DESCRIBE_MODEL}.` })),
