...
- **Relative placements:** the live cursor and similar overlays use a transparent virtual-placeholder anchor plus relative placements, matching the protocol's intended pattern.
