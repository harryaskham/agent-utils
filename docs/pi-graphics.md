...
* Message and TUI box chrome has per-surface effects (`glass`, `aurora`,
  ...
  `metronome`, `hourglass`, `signal`, `halo`, `caret`, `bevel`, `chamfer`, `atelier`, `constellation`, `palette`, `satellite`, `orbit`, `emblem`, `crest`,
  `sigil`, `rune`, `panel`, `fold`, `archive`, `lantern`, `choice`, `nebula`, `ticker`, `waveform`, `marquee`, `ribbon`, `ledger`, `lens`, `aperture`, `gauge`, `dial`,
