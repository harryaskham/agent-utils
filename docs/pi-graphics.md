...
* Message and TUI box chrome has per-surface effects (`glass`, `aurora`,
  ...
  `contour`, `folio`, `manuscript`, `note`, `tapestry`, `weave`, `glyph`, `blueprint`, `grove`, `vine`, `dendrite`, `helix`, `braid`,
  ...
  bash surfaces get terminal command rails, cursor blocks, and shell ticks, tree surfaces get grove trunk rails, branch forks, and leaf nodes,
