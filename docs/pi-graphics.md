...
* Message and TUI box chrome has per-surface effects (`glass`, `aurora`,
  ...
  `metronome`, `shuttle`, `hourglass`, `signal`, `halo`, `margin`, `caret`, `bevel`, `chamfer`, `atelier`, `constellation`, `swatch`, `palette`, `satellite`, `orbit`, `emblem`, `crest`,
  ...
  surfaces get lens focus brackets, glass glints, and crop-guide ticks, editor surfaces get manuscript gutters, edit pins, and draft guide marks, border surfaces get bevel planes, clipped-corner highlights, and shadow seams, input surfaces get
