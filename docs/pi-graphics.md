...
* Message and TUI box chrome has per-surface effects (`glass`, `aurora`,
  ...
  `metronome`, `hourglass`, `signal`, `halo`, `caret`, `bevel`, `chamfer`, `atelier`, `constellation`, `swatch`, `palette`, `satellite`, `orbit`, `emblem`, `crest`,
