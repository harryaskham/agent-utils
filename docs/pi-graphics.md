...
* Message and TUI box chrome has per-surface effects (`glass`, `aurora`,
  ...
  `console`, `slider`, `caliper`, `dashboard`, `tile`, `mosaic`, `portal`, `token`, `keyring`, `keystone`, `tag`, `badge`, `picker`, `sextant`, `compass`, `terminal`, `prompt`,
  ...
  portal threshold frames and entry glints, OAuth provider selectors get token exchange rails, token chips, and consent pips,
