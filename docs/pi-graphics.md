...
* Message and TUI box chrome has per-surface effects (`glass`, `aurora`,
  ...
  `orbit`, `rune`, `fold`, `nebula`, `waveform`, `ribbon`, `aperture`, and
  `caliper`) and caches both uploads and relative placements so ordinary rerenders
  do not re-place identical box strips. Thinking blocks are detected from assistant
  message content and get sparse nebula mist lanes, assistant surfaces get calm
  topographic contour bands, skill/custom-TUI surfaces get compact rune sigils,
  ...
  widget surfaces keep a low-entropy structural lattice. If a box moves or resizes, stale relative
