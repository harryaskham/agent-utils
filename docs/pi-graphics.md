...
* Message and TUI box chrome has per-surface effects (`glass`, `aurora`,
  ...
  warm lantern slats, thinking selector surfaces get ballot voting cards, decision holes, and ranked ticks, assistant surfaces get folio page margins, annotation tabs, and reading guide marks, skill surfaces get sigil seals, binding ticks, and invocation marks,
