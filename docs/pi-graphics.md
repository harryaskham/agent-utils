...
* Message and TUI box chrome has per-surface effects (`glass`, `aurora`,
  ...
  `sigil`, `rune`, `workbench`, `panel`, `fold`, `archive`, `lantern`, `ballot`, `choice`, `nebula`, `ticker`, `waveform`, `masthead`, `marquee`, `ribbon`, `logbook`, `ledger`, `lens`, `aperture`, `gauge`, `dial`,
  ...
  warm lantern slats, thinking selector surfaces get ballot voting cards, decision holes, and ranked ticks, assistant surfaces get illuminated manuscript margins, skill surfaces get sigil seals, binding ticks, and invocation marks,
  custom-TUI surfaces get workbench dock rails, resize grips, and widget sockets, tool surfaces get schematic bus traces and pads,
