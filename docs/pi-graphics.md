...
* Message and TUI box chrome has per-surface effects (`glass`, `aurora`,
  ...
  `contour`, `folio`, `manuscript`, `tapestry`, `weave`, `glyph`, `blueprint`, `vine`, `dendrite`, `helix`, `braid`,
