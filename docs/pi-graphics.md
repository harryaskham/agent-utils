...
* Message and TUI box chrome has per-surface effects (`glass`, `aurora`,
  ...
  `console`, `slider`, `caliper`, `dashboard`, `tile`, `mosaic`, `gate`, `portal`, `token`, `keyring`, `keystone`, `tag`, `badge`, `picker`, `sextant`, `compass`, `terminal`, `prompt`,
