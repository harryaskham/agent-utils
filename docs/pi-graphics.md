...
* Message and TUI box chrome has per-surface effects (`glass`, `aurora`,
  ...
  `console`, `slider`, `caliper`, `tile`, `mosaic`, `portal`, `keyring`, `keystone`, `tag`, `badge`, `sextant`, `compass`, `terminal`, `prompt`,
