...
* Message and TUI box chrome has per-surface effects (`glass`, `aurora`,
  ...
  `metronome`, `hourglass`, `signal`, `halo`, `caret`, `bevel`, `chamfer`, `atelier`, `constellation`, `palette`, `satellite`, `orbit`, `crest`,
  ...
  agent surfaces get satellite rails, telemetry pips, and signal tags, mascot surfaces get crest plates and chevrons, custom surfaces
  get atelier drafting tabs, maker marks, and bespoke guide rails, theme surfaces get palette chip bars and calibration ticks, user surfaces get tapestry bands, selvage ticks, and message-thread knots,
