...
* Message and TUI box chrome has per-surface effects (`glass`, `aurora`,
  ...
  `sigil`, `rune`, `workbench`, `panel`, `fold`, `archive`, `candle`, `lantern`, `ballot`, `choice`, `nebula`, `ticker`, `waveform`, `masthead`, `marquee`, `ribbon`, `logbook`, `ledger`, `crop`, `lens`, `aperture`, `gauge`, `dial`,
